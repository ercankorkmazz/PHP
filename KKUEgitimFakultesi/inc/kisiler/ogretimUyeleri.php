<div class="icerik">
  <div class="icerikSol">
  <h3 style="margin:0 0 0 5px;">Öðretim Üyeleri</h3>
            ...
            <tr><td class="tr">
                ...
                <tr>
                  <td align="right" style="border:0;"><strong>Bilgiler :</strong></td>
                    <td style="border:0;">Akademik bilgileri i&ccedil;in <a href="index.php?<?php if(!empty($alanlar['link'])) echo "uyeUrl=".$alanlar['link']; else echo "ogretimUyeleri"; ?>">týklayýnýz.</a></td>
                </tr>
                </table>
        </td></tr>
        <?php }if($kontrol==0){ ?>
