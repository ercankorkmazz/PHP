<?php		
	...
	if(isset($_GET["arastirmaGorevlisi"]) and isset($_FILES['dosya']))
		@include("inc/kisiler/arasGorevFotoYukle.php"); // Fotoðraf yükler
	
	if(isset($_GET["arastirmaGorevlisi"]) and isset($_POST["fotoSil"]))
		@include("inc/kisiler/arasGorevFotoSil.php"); // Fotoðraf Siler
	
	if(isset($_GET["arastirmaGorevlisi"]) and isset($_POST["adSoyad"]))
		@include("inc/kisiler/arasGorevGuncelle.php"); // Bilgileri Günceller Günceller
?>
<div class="bolumHakkinda">
	<form method="post" target="_self" action="index.php?arastirmaGorevlisi=<?php echo $alanlar['id']; ?>" enctype="multipart/form-data">
    ...
    <form method="post" target="_self" action="index.php?arastirmaGorevlisi=<?php echo $alanlar['id']; ?>">
    ...
    <table width="100%" border="0" style="font-size:12px;margin-top:-145px;margin-left:90px;">
      ...
      <tr>
        ...
        <td><div class="txtBG" style="width:200px;"><input type="text" name="gorev" value="<?php echo $alanlar['unvan']; ?>" style="width:200px;"></div></td>
      </tr>
      <tr>
