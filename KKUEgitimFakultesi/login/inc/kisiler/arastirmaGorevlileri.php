<?php 
	...
	if(isset($_GET["arastirmaGorevlileri"]) and isset($_POST["adSoyad"]))
		@include("inc/kisiler/arasGorevEkle.php"); // Araþtýrma Görevlisi Kaydeder
		
	if(isset($_GET["arastirmaGorevlileri"]) and isset($_POST["coklu"]))
		@include("inc/kisiler/arasGorevSil.php"); // Kiþi siler
?>
<div class="bolumHakkinda">
    ...
    <table width="100%" border="0" style="font-size:12px;margin-top:-145px;margin-left:90px;">
      ...
      <tr>
        <td colspan="2"><input type="submit" value="Araþtýrma Görevlisini Kaydet" class="button" style="margin:2px 0 0 257px;" /></td>
      </tr>
    </table>
	</form>
