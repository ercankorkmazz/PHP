...
*/
if(($_SESSION["$_SERVER[SERVER_NAME]mezunportalikadi"]=="admin") or ($_SESSION["$_SERVER[SERVER_NAME]mezunportalitur"]==1))
{
	$baseUrl = '/mezunPortali/ckfinder/userfiles/';
}
else
	$baseUrl = '/mezunPortali/ckfinder/userfiles/mezun/';
