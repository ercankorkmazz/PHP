  ...
  <div class="icerikSol" style="padding-top:0;">
        <div class="bolumHakkinda">
            ...
            <form method="post" action="index.php?bolumler" target="_self">
                <h3 style="margin:30px 0 -15px 0;">Sisteme Kayýtlý Bölüm / Anabilim Dallarý</h3>
                <input type="submit" value="Seçili Bölüm / Anabilim Dallarýný Sil" class="button" style="margin:5px 0 0 5px; float:right;" /><br/><hr/>
