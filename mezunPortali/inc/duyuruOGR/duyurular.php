<?php 
	if(isset($_GET["duyurularOGR"]) and isset($_POST["duyuruBilgi"]))
		@include("inc/duyuruOGR/duyuruEkle.php"); // Duyuru ekler
	
	if(isset($_GET["duyurularOGR"]) and isset($_POST["coklu"]))
		@include("inc/duyuruOGR/duyuruSil.php"); // Duyuru siler
?>
<div class="icerik">
  <div class="icerikSol" style="padding-top:0;">
        <div class="bolumHakkinda">
            <form method="post" target="_self" action="index.php?duyurularOGR">
            ...
            <form method="post" action="index.php?duyurularOGR" target="_self">
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="7" class="table" style="margin-top:25px;"> 
                    <?php
                        ...
                        $sorgu=mysql_query("select * from duyurular where ogr=".$_SESSION["$_SERVER[SERVER_NAME]mezunportalikID"]);
                    ...
                    <tr>
                        ...
                        <td style="width:20px;"><a href="index.php?duyuruOGR=<?php echo $alanlar["id"] ;?>" target="_self"><img src="img/kalem.png" /></a></td>
                    </tr>
                    <?php } ?>
                </table>
            </form>
