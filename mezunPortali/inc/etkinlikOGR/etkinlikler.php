<?php 
	if(isset($_GET["etkinliklerOGR"]) and isset($_POST["etkinlikBaslik"]))
		@include("inc/etkinlikOGR/etkinlikEkle.php"); // etkinlik ekler
	
	if(isset($_GET["etkinliklerOGR"]) and isset($_POST["coklu"]))
		@include("inc/etkinlikOGR/etkinlikSil.php"); // etkinlik siler
?>
<div class="icerik">
  <div class="icerikSol" style="padding-top:0;">
        <div class="bolumHakkinda">
            <form method="post" target="_self" action="index.php?etkinliklerOGR">
            ...
            <form method="post" action="index.php?etkinliklerOGR" target="_self">
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="7" class="table" style="margin-top:25px;"> 
                    <?php
                        ...
                        $sorgu=mysql_query("select * from etkinlikler where ogr=".$_SESSION["$_SERVER[SERVER_NAME]mezunportalikID"]);
                    ...
                    <tr>
                        ...
                        <td style="width:20px;"><a href="index.php?etkinlikOGR=<?php echo $alanlar["id"] ;?>" target="_self"><img src="img/kalem.png" /></a></td>
                    </tr>
                    <?php } ?>
                </table>
            </form>
