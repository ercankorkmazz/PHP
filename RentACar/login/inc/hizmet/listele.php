    <div class="sol rent" style="width: 980px;">
		<div class="sol sayfa" style="width:996px; height:38px; margin-bottom:10px; padding:2px;">
        	<div class="sol" style="padding-top:7px;"><span class="title">Hizmetler & Kampanyalar</span></div>
			<div class="sag" style="padding:0px;">
				<div class="sol">
		        	<a href="index.php?yenihizmet" id="btn">Yeni Hizmet</a>						
		        </div>						
			</div>
		</div>
		...
		?>
                ...
                <div class="sol ilk" style="width: 860px;" id="smallTitle"><?php echo @mb_convert_encoding("$alanlar[BaslikTR]", "UTF-8", "ISO-8859-9"); ?></div>						
                <div class="sol" style="width:50px; text-align:center; padding:5px 0">
                  <a href="index.php?hizmetsil=<?php echo $alanlar["id"]; ?>" class="silBTN">&nbsp;</a>
                </div>							
                <div class="sol" style="width:36px; text-align:center; padding:5px 0">
                	<a href="index.php?hizmetduzenle=<?php echo $alanlar["id"]; ?>" class="duzenleBTN">&nbsp;</a>
                </div>
			<?php }
                if($kontrol==0)
