...
<script type="text/javascript">
	function dersler(){
		window.location="index.php?scratch&scratchDersler";	
	}
</script>
<section id="home">
	<div class="pTabGenel pTab2" style="width:1305px;">
        <h2 style="float:right;margin-right:55px;">SCRATCH</h2>
        ...
        <ul class="pTabListe" style="float:left;">
            ...
            <?php if(isset($_SESSION["$_SERVER[SERVER_NAME]uyeOturum"])){ ?> 
                <li><a href="index.php" style="text-decoration:none;" onclick="dersler();">DERS EKLE</a></li>
            <?php } ?>
		</ul>
        ...
        <div style="width:100%;">
            <div class="pTabContent" id="karsilama">
                <?php 
                    echo $kayit["scr"];  // Hakkýnda bölümü 
                ?>
            </div>
            ...
            <div class="pTabContent">
                ...
                <div id="metinAlan">
                    <?php
						include("inc/uyeDers/scratch/ders.php");	
                    ?>
                ...
                <div id="blok">
                    ...
                    <?php
                        ...
                        $sayi=mysql_num_rows(mysql_query("select * from scratch where onay='1' order by id desc"));
                    ...
                    <div id="liste">
                        ...
                        <?php
                            include("login/inc/baglan.php");
                            $bul=mysql_query("select * from scratch where onay='1' and tanitim='1' order by puan desc");
                        ...
                        ?>
                            ...
                            <table width='99%' border="0" style="height:30px;">
                                <tr>
                                	...
                                	<td style="height:25px;">
                                    	<li class="devamiBTN" style="width:100%;"><a href="index.php?scratch&devam=<?php echo $veri['id']; ?>" style="display:block;"><?php echo $veri['baslik']; ?> &raquo;</a>
                                	</td>
                                </tr>
                            </table>
                            </div> <!-- ders div sonu -->
                            ...
                            <?php
                            include("login/inc/baglan.php");
                            $bul=mysql_query("select * from scratch where onay='1' and tanitim='0' order by puan desc");
                            while($veri=mysql_fetch_array($bul))
                            {
                        ?>
                            <div id='ders'>
                            <table width='99%' border="0" style="height:120px;">
                                ...
                                <tr>
                                  <td style="height:25px;">
                                    <li class="devamiBTN"><a href="index.php?scratch&devam=<?php echo $veri['id']; ?>" style="display:block;">Devamý &raquo;</a>
                                  </td>
                                </tr>
                            </table>
                            </div> <!-- ders div sonu -->
            ...
            <?php if(isset($_SESSION["$_SERVER[SERVER_NAME]uyeOturum"])){ ?> 
                <div class="pTabContent" id="karsilama">
                	<?php
						if(isset($_GET["scratchDuzenle"]))
							include("inc/uyeDers/scratch/duzenle.php");
						else
							include("inc/uyeDers/scratch/dersler.php");	
					?>
                </div>
            <?php } ?>
