<?php
	...
	{ 
		...
		if((isset($_GET["aliceDuzenle"])) and (isset($_POST["baslik"])))
			@include('inc/uyeDers/alice/adminGuncelle.php');
		if((isset($_GET["aliceDuzenle"])) and (isset($_GET["dosyaSil"])))
		{
			...
			header("Location:index.php?alice&aliceDuzenle=".$_GET['aliceDuzenle']);
		}
		...
		<div style="width:740px;float:left;">
            <form method="post" target="_self" action="index.php?alice&aliceDuzenle=<?php echo $_GET['aliceDuzenle']; ?>" enctype="multipart/form-data">
                ...
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td style="width:87px;"> <a class="Button" style="float:left; margin:3px 0 0 5px;color:#FFF;" href="index.php?PDFSil&alice&aliceDuzenle=<?php echo $_GET['aliceDuzenle']; ?>">Dosya Sil</a></td>
                    <td style="width:37px;"> <a class="Button" style="float:left; margin:3px 0 0 0px;color:#FFF;" href="dosyalar/alice/<?php echo $alanlar['PDF']; ?>">Ýndir</a></td>
                    <?php } ?>
                ...
                <h5><strong>Proje dosyasýný buradan y&uuml;kleyiniz.</strong><span style="font-size:12px;"> &raquo; Formatlar: a3p</span></h5>
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td style="width:87px;"> <a class="Button" style="float:left; margin:3px 0 0 5px;color:#FFF;" href="index.php?dosyaSil&alice&aliceDuzenle=<?php echo $_GET['aliceDuzenle']; ?>">Dosya Sil</a></td>
                    <td style="width:37px;"> <a class="Button" style="float:left; margin:3px 0 0 0px;color:#FFF;" href="dosyalar/alice/<?php echo $alanlar['dosya']; ?>">Ýndir</a></td>
                    <?php } ?>
