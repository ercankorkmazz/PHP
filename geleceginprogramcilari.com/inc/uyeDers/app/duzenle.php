<?php
	...
	{ 
		...
		if((isset($_GET["appDuzenle"])) and (isset($_POST["baslik"])))
			@include('inc/uyeDers/app/adminGuncelle.php');
		if((isset($_GET["appDuzenle"])) and (isset($_GET["dosyaSil"])))
		{
			...
			header("Location:index.php?app&appDuzenle=".$_GET['appDuzenle']);
		}
		...
		<div style="width:740px;float:left;">
            <form method="post" target="_self" action="index.php?app&appDuzenle=<?php echo $_GET['appDuzenle']; ?>" enctype="multipart/form-data">
                ...
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td style="width:87px;"> <a class="Button" style="float:left; margin:3px 0 0 5px;color:#FFF;" href="index.php?PDFSil&app&appDuzenle=<?php echo $_GET['appDuzenle']; ?>">Dosya Sil</a></td>
                    <td style="width:37px;"> <a class="Button" style="float:left; margin:3px 0 0 0px;color:#FFF;" href="dosyalar/app/<?php echo $alanlar['PDF']; ?>">Ýndir</a></td>
                    <?php } ?>
                ...
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td style="width:87px;"> <a class="Button" style="float:left; margin:3px 0 0 5px;color:#FFF;" href="index.php?dosyaSil&app&appDuzenle=<?php echo $_GET['appDuzenle']; ?>">Dosya Sil</a></td>
                    <td style="width:37px;"> <a class="Button" style="float:left; margin:3px 0 0 0px;color:#FFF;" href="dosyalar/app/<?php echo $alanlar['dosya']; ?>">Ýndir</a></td>
                    <?php } ?>
