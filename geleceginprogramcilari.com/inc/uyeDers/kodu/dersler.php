<?php 
	if(isset($_GET["koduDersler"]) and isset($_POST["icerik"]))
		@include("inc/uyeDers/kodu/dersKaydet.php"); // Ders kaydet
	
	if(isset($_GET["koduDersler"]) and isset($_POST["coklu"]))
		@include("inc/uyeDers/kodu/dersSil.php"); // Ders Sil
?>
	<div style="width:740px;float:left;">
		<form method="post" target="_self" action="index.php?kodu&koduDersler" enctype="multipart/form-data">
    ...
    <div class="clear"></div>
    <form method="post" action="index.php?kodu&koduDersler" target="_self">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="7" class="table"> 
            <?php
				...
				$sorgu=mysql_query("select * from kodu where  yazarID='$uyeId' order by id desc");
            ...
            <tr>
                ...
                <td style="width:20px;"><a href="index.php?kodu&koduDuzenle=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/kalem.png" /></a></td>
            </tr>
