<?php
	...
	{ 
		...
		if((isset($_GET["koduDuzenle"])) and (isset($_POST["baslik"])))
			@include('inc/uyeDers/kodu/adminGuncelle.php');
		if((isset($_GET["koduDuzenle"])) and (isset($_GET["dosyaSil"])))
		{
			...
			header("Location:index.php?kodu&koduDuzenle=".$_GET['koduDuzenle']);
		}
		...
		<div style="width:740px;float:left;">
            <form method="post" target="_self" action="index.php?kodu&koduDuzenle=<?php echo $_GET['koduDuzenle']; ?>" enctype="multipart/form-data">
                ...
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td style="width:87px;"> <a class="Button" style="float:left; margin:3px 0 0 5px;color:#FFF;" href="index.php?PDFSil&kodu&koduDuzenle=<?php echo $_GET['koduDuzenle']; ?>">Dosya Sil</a></td>
                    <td style="width:37px;"> <a class="Button" style="float:left; margin:3px 0 0 0px;color:#FFF;" href="dosyalar/kodu/<?php echo $alanlar['PDF']; ?>">Ýndir</a></td>
                    <?php } ?>
                ...
                <h5><strong>Proje dosyasýný buradan y&uuml;kleyiniz.</strong><span style="font-size:12px;"> &raquo; Formatlar: kodu - kodu2</span></h5>
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td style="width:87px;"> <a class="Button" style="float:left; margin:3px 0 0 5px;color:#FFF;" href="index.php?dosyaSil&kodu&koduDuzenle=<?php echo $_GET['koduDuzenle']; ?>">Dosya Sil</a></td>
                    <td style="width:37px;"> <a class="Button" style="float:left; margin:3px 0 0 0px;color:#FFF;" href="dosyalar/kodu/<?php echo $alanlar['dosya']; ?>">Ýndir</a></td>
                    <?php } ?>
