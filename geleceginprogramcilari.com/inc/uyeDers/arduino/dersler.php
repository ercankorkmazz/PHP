<?php 
	if(isset($_GET["arduinoDersler"]) and isset($_POST["icerik"]))
		@include("inc/uyeDers/arduino/dersKaydet.php"); // Ders kaydet
	
	if(isset($_GET["arduinoDersler"]) and isset($_POST["coklu"]))
		@include("inc/uyeDers/arduino/dersSil.php"); // Ders Sil
?>
    <div style="width:740px;float:left;">
        <form method="post" target="_self" action="index.php?arduino&arduinoDersler" enctype="multipart/form-data">
    ...
    <div class="clear"></div>
    <form method="post" action="index.php?arduino&arduinoDersler" target="_self">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="7" class="table"> 
            <?php
				...
				$sorgu=mysql_query("select * from smallbasic where  yazarID='$uyeId' order by id desc");
            ...
            <tr>
                ...
                <td style="width:20px;"><a href="index.php?arduino&arduinoDuzenle=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/kalem.png" /></a></td>
            </tr>
