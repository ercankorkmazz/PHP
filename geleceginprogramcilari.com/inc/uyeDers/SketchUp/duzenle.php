            ...
            <form method="post" target="_self" action="index.php?SketchUp&SketchUpDuzenle=<?php echo $_GET['SketchUpDuzenle']; ?>" enctype="multipart/form-data">
                ...
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td style="width:37px;"> <a class="Button" style="float:left; margin:3px 0 0 0px;color:#FFF;" href="dosyalar/sketchup/<?php echo $alanlar['PDF']; ?>">Ýndir</a></td>
                    <?php } ?>
                ...
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td style="width:37px;"> <a class="Button" style="float:left; margin:3px 0 0 0px;color:#FFF;" href="dosyalar/sketchup/<?php echo $alanlar['dosya']; ?>">Ýndir</a></td>
                    <?php } ?>
