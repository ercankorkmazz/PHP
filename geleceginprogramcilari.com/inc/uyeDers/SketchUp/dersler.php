<?php 
	if(isset($_GET["SketchUpDersler"]) and isset($_POST["icerik"]))
		@include("inc/uyeDers/SketchUp/dersKaydet.php"); // Ders kaydet
	
	if(isset($_GET["SketchUpDersler"]) and isset($_POST["coklu"]))
		@include("inc/uyeDers/SketchUp/dersSil.php"); // Ders Sil
?>
	<div style="width:740px;float:left;">
		<form method="post" target="_self" action="index.php?SketchUp&SketchUpDersler" enctype="multipart/form-data">
            ...
            <h5><strong>Proje dosyasýný buradan y&uuml;kleyiniz.</strong><span style="font-size:12px;"> &raquo; Formatlar: skp</span></h5>
    ...
    <div class="clear"></div>
    <form method="post" action="index.php?SketchUp&SketchUpDersler" target="_self">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="7" class="table"> 
            <?php
				...
				$sorgu=mysql_query("select * from sketchup where yazarID='$uyeId' order by id desc");
            ...
            <tr>
                ...
                <td style="width:20px;"><a href="index.php?SketchUp&SketchUpDuzenle=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/kalem.png" /></a></td>
            </tr>
