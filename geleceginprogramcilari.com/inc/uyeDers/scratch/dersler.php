<?php 
	if(isset($_GET["scratchDersler"]) and isset($_POST["icerik"]))
		@include("inc/uyeDers/scratch/dersKaydet.php"); // Ders kaydet
	
	if(isset($_GET["scratchDersler"]) and isset($_POST["coklu"]))
		@include("inc/uyeDers/scratch/dersSil.php"); // Ders Sil
?>
    <div style="width:740px;float:left;">
        <form method="post" target="_self" action="index.php?scratch&scratchDersler" enctype="multipart/form-data">
    ...
    <div class="clear"></div>
    <form method="post" action="index.php?scratch&scratchDersler" target="_self">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="7" class="table"> 
            <?php
				...
				$sorgu=mysql_query("select * from scratch where  yazarID='$uyeId' order by id desc");
            ...
            <tr>
                ...
                <td style="width:20px;"><a href="index.php?scratch&scratchDuzenle=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/kalem.png" /></a></td>
            </tr>
