...
<script type="text/javascript">
	function apdersler(){
		window.location="index.php?app&appDersler";	
	}
</script>

<section id="contact-us">  
  <div class="pTabGenel pTab2" style="width:1305px;">
        <h2 style="float:right;margin-right:55px;">APP INVENTOR</h2>
        ...
        <div style="width:100%;">
            <div class="pTabContent" id="karsilama">
                <?php 
                    echo $kayit["app"];  // Hakkýnda bölümü 
                ?>
            </div>
            ...
            <div class="pTabContent">
                ...
                <div id="metinAlan">
                    <?php
						include("inc/uyeDers/app/ders.php");
                    ?>
                ...
                <div id="blok">
                    ...
                    <?php
                        ...
                        $sayi=mysql_num_rows(mysql_query("select * from app where onay='1' order by id desc"));
                    ...
                    <div id="liste">
                        ...
                        <?php
                            include("login/inc/baglan.php");
                            $bul=mysql_query("select * from app where onay='1' and tanitim='1' order by puan desc");
                        ...
                        ?>
                            ...
                            <table width='99%' border="0" style="height:30px;">
                                <tr>
                                	...
                                	<td style="height:25px;">
                                    	<li class="devamiBTN" style="width:100%;"><a href="index.php?app&devam=<?php echo $veri['id']; ?>" style="display:block;"><?php echo $veri['baslik']; ?> &raquo;</a>
                                	</td>
                                </tr>
                            </table>
                            </div> <!-- ders div sonu -->
                            ...
                            include("login/inc/baglan.php");
                            $bul=mysql_query("select * from app where onay='1' and tanitim='0' order by puan desc");
                            while($veri=mysql_fetch_array($bul))
                            {
                        ?>
                            <div id='ders'>
                            <table width='99%' border="0" style="height:120px;">
                                ...
                                <tr>
                                  <td style="height:25px;">
                                    <li class="devamiBTN"><a href="index.php?app&devam=<?php echo $veri['id']; ?>" style="display:block;">Devamý &raquo;</a>
                                  </td>
                                </tr>
                            </table>
                            </div> <!-- ders div sonu -->
             ...
             <?php if(isset($_SESSION["$_SERVER[SERVER_NAME]uyeOturum"])){ ?> 
                <div class="pTabContent" id="karsilama">
                	<?php
						if(isset($_GET["appDuzenle"]))
							include("inc/uyeDers/app/duzenle.php");
						else
							include("inc/uyeDers/app/dersler.php");	
					?>
                </div>
            <?php } ?>
		</div>
