...
<script type="text/javascript">
	function adersler(){
		window.location="index.php?alice&aliceDersler";	
	}
</script>

<section id="about">
	<div class="pTabGenel pTab2" style="width:1305px;">
      <h2 style="float:right;margin-right:55px;">ALICE</h2>
      ...
      <ul class="pTabListe" style="float:left;">
        ...
        <?php if(isset($_SESSION["$_SERVER[SERVER_NAME]uyeOturum"])){ ?> 
			<li><a href="index.php" style="text-decoration:none;" onclick="adersler();">DERS EKLE</a></li>
            <?php } ?>
      </ul>
      ...
      <div style="clear:both;"></div>
            ...
            <div style="width:100%;">
                <div class="pTabContent" id="karsilama">
                    <?php 
                        echo $kayit["alc"];  // Hakkýnda bölümü 
                    ?>
                </div>
                ...
                <div class="pTabContent">
                    ...
                    <div id="metinAlan">
                       <?php
						include("inc/uyeDers/alice/ders.php");	
                    ?>
                    ...
                    <div id="blok">
                        ...
                        <?php
							...
							$sayi=mysql_num_rows(mysql_query("select * from alice where onay='1' order by id desc"));
                        ...
                        <div id="liste">
                            ...
                            <?php
                            include("login/inc/baglan.php");
                            $bul=mysql_query("select * from alice where onay='1' and tanitim='1' order by puan desc");
                        ...
                        ?>
                            ...
                            <table width='99%' border="0" style="height:30px;">
                                <tr>
                                	...
                                	<td style="height:25px;">
                                    	<li class="devamiBTN" style="width:100%;"><a href="index.php?alice&devam=<?php echo $veri['id']; ?>" style="display:block;"><?php echo $veri['baslik']; ?> &raquo;</a>
                                	</td>
                                </tr>
                            </table>
                            </div> <!-- ders div sonu -->
                            <?php
                                ...
                                include("login/inc/baglan.php");
                                $bul=mysql_query("select * from alice where onay='1' and tanitim='0' order by puan desc");
                                while($veri=mysql_fetch_array($bul))
                                {
                            ?>
                                <div id='ders'>
                                <table width='99%' border="0" style="height:120px;">
                                    ...
                                    <tr>
                                      <td style="height:25px;">
                                        <li class="devamiBTN"><a href="index.php?alice&devam=<?php echo $veri['id']; ?>" style="display:block;">Devamý &raquo;</a>
                                      </td>
                                    </tr>
                                </table>
                                </div> <!-- ders div sonu -->
                 ...
                 <?php if(isset($_SESSION["$_SERVER[SERVER_NAME]uyeOturum"])){ ?> 
                     <div class="pTabContent" id="karsilama">
                        <?php
                            if(isset($_GET["aliceDuzenle"]))
                                include("inc/uyeDers/alice/duzenle.php");
                            else
                                include("inc/uyeDers/alice/dersler.php");	
                        ?>
                    </div>
            <?php } ?>
         </div>
