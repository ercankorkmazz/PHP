<?php
	...
	if((isset($_GET["SketchUpDuzenle"])) and (isset($_POST["baslik"])))
		@include('inc/SketchUp/adminGuncelle.php');
	if((isset($_GET["SketchUpDuzenle"])) and (isset($_GET["dosyaSil"])))
	{
		...
		header("Location:index.php?koduDuzenle=".$_GET['SketchUpDuzenle']);
	}
	...
	?>
    <form method="post" target="_self" action="index.php?SketchUpDuzenle=<?php echo $_GET['SketchUpDuzenle']; ?>" enctype="multipart/form-data">
        ...
        <table width="100%" border="0" style="margin:-3px;">
          <tr>
            ...
            <td style="width:80px;"> <a class="Button" style="float:left; margin:3px 0 0 0; width:75px;text-align:center;" href="index.php?PDFSil&SketchUpDuzenle=<?php echo $_GET['SketchUpDuzenle']; ?>">Dosyayý Sil</a></td>
        ...
        <table width="100%" border="0" style="margin:-3px;">
          <tr>
            ...
            <td style="width:80px;"> <a class="Button" style="float:left; margin:3px 0 0 0; width:75px;text-align:center;" href="index.php?dosyaSil&SketchUpDuzenle=<?php echo $_GET['SketchUpDuzenle']; ?>">Dosyayý Sil</a></td>
