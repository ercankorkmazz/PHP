<?php 
	...
	if(isset($_GET["aliceDersler"]) and isset($_POST["coklu"]))
		@include("inc/alice/dersSil.php"); // Ders Sil
?>
	<form method="post" target="_self" action="index.php?aliceDersler" enctype="multipart/form-data">
    ...
    <form method="post" action="index.php?aliceDersler" target="_self">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="7" class="table" style="margin-top:25px;"> 
            <?php
				...
				$sorgu=mysql_query("select * from alice order by id desc");
            ...
            <tr>
                ...
                <td style="width:22px;"><a href="index.php?aliceYorumlar=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/yorum.png" /></a></td>
                <td style="width:20px;"><a href="index.php?aliceDuzenle=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/kalem.png" /></a></td>
            </tr>
            <?php } ?>
        </table>
    </form>