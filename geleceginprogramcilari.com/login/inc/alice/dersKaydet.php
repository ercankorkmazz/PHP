<?php
		...
		if(($videoKontrol==1) or ($videoKontrol==2))
		{
			...
			if((@$_FILES["dosya"]["size"]!=0) and (@$_FILES["PDF"]["size"]!=0))
			{
				...
				{			
					...
					{
						$sql="insert into alice (baslik,PDF,dosya,video,icerik,yazarID,onay) values ('$_POST[baslik]','$PDF','$dosya','$kod','$_POST[icerik]','','1')";
						$kontrol=1;
					}
					else
	...
	header("Location:index.php?aliceDersler");
?>