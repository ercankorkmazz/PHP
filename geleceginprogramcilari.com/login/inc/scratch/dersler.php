<?php 
	if(isset($_GET["scratchDersler"]) and isset($_POST["icerik"]))
		@include("inc/scratch/dersKaydet.php"); // Ders kaydet
	
	if(isset($_GET["scratchDersler"]) and isset($_POST["coklu"]))
		@include("inc/scratch/dersSil.php"); // Ders Sil
?>
	<form method="post" target="_self" action="index.php?scratchDersler" enctype="multipart/form-data">
    ...
    <form method="post" action="index.php?scratchDersler" target="_self">
    	<h5 style="margin:30px 0 -15px 0;">Sisteme Kayýtlý Dersler</h5>
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="7" class="table" style="margin-top:25px;"> 
            <?php
				...
				$sorgu=mysql_query("select * from scratch order by id desc");
            ...
            <tr>
                ...
                <td style="width:22px;"><a href="index.php?scratchYorumlar=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/yorum.png" /></a></td>
                <td style="width:24px;"><a href="index.php?scratchDuzenle=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/kalem.png" /></a></td>
            </tr>
            <?php } ?>
        </table>
    </form>