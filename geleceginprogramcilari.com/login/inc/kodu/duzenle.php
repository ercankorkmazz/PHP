    ...
    <form method="post" target="_self" action="index.php?koduDuzenle=<?php echo $_GET['koduDuzenle']; ?>" enctype="multipart/form-data">
        ...
        <table width="100%" border="0" style="margin:-3px;">
          <tr>
            ...
            <td style="width:80px;"> <a class="Button" style="float:left; margin:3px 0 0 0; width:75px;text-align:center;" href="index.php?PDFSil&koduDuzenle=<?php echo $_GET['koduDuzenle']; ?>">Dosyayý Sil</a></td>
        ...
        <table width="100%" border="0" style="margin:-3px;">
          <tr>
            ...
            <td style="width:80px;"> <a class="Button" style="float:left; margin:3px 0 0 0; width:75px;text-align:center;" href="index.php?dosyaSil&koduDuzenle=<?php echo $_GET['koduDuzenle']; ?>">Dosyayý Sil</a></td>
