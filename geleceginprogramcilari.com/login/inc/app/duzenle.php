    ...
    <form method="post" target="_self" action="index.php?appDuzenle=<?php echo $_GET['appDuzenle']; ?>" enctype="multipart/form-data">
        ...
        <table width="100%" border="0" style="margin:-3px;">
          <tr>
            ...
            <td style="width:80px;"> <a class="Button" style="float:left; margin:3px 0 0 0; width:75px;text-align:center;" href="index.php?PDFSil&appDuzenle=<?php echo $_GET['appDuzenle']; ?>">Dosyayý Sil</a></td>
        ...
        <table width="100%" border="0" style="margin:-3px;">
          <tr>
            ...
            <td style="width:80px;"> <a class="Button" style="float:left; margin:3px 0 0 0; width:75px;text-align:center;" href="index.php?dosyaSil&appDuzenle=<?php echo $_GET['appDuzenle']; ?>">Dosyayý Sil</a></td>
