<?php 
	...
	if(isset($_GET["appDersler"]) and isset($_POST["coklu"]))
		@include("inc/app/dersSil.php"); // Ders Sil
?>
	<form method="post" target="_self" action="index.php?appDersler" enctype="multipart/form-data">
    ...
    <form method="post" action="index.php?appDersler" target="_self">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="7" class="table" style="margin-top:25px;"> 
            <?php
				...
				$sorgu=mysql_query("select * from app order by id desc");
            ...
            <tr>
                ...
                <td style="width:22px;"><a href="index.php?appYorumlar=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/yorum.png" /></a></td>
                <td style="width:20px;"><a href="index.php?appDuzenle=<?php echo $alanlar['id']; ?>" style="border:0px;"><img src="img/kalem.png" /></a></td>
            </tr>
            <?php } ?>
        </table>
    </form>