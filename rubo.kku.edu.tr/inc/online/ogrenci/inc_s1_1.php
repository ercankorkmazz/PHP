            ...
            <div class="row">
              ...
              <div class="col-sm-6 templatemo_onlineSayfa basliksiz min670px" style="float:right;">
                <div class="aciklamalar">
                    ...
                    <div class="aciklama">
                        <span>Açýklama: </span> Ay Ýstasyonundan geçen hafta gelen görüntüleri izleyip, grup arkadaþlarýnýzla neler olduðu konusunda tartýþýnýz. 
                    </div>
                </div>
                <div id="player_a" class="projekktor"></div>
              	<div class="btnDiv">
                	<a href="index.php?kontrol=1585">Tanýtýmý geç &raquo;</a>
                </div>
