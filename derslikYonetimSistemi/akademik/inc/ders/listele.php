...
<form method="post" action="index.php?dersler" target="_self">
    	<div class="menuAdi">
        	<div class="ad">
            	<h3>Diðer Birimlere Ait Dersler</h3>
		...
		?>
            <tr>
                ...
                <td style="width:110px;" align="center"><strong><?php echo "$alanlar[oTuru]. Öðretim" ;?></strong></td>
                <td style="width:20px;"><a href="index.php?ders=<?php echo $alanlar['id'] ?>" target="_self"><img src="../img/kalem.png" /></a></td>
            </tr>
        <?php }
		if($kontrol==0)
			echo "<tr><td style='padding:15px;'>Hiçbir ders bulunamadý.</td></tr>";
		 ?>
        </table>
</form>