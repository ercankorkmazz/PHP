        ...
        <form action="index.php?EDFormu" method="post">
        ...
        <input type="submit" value="Ýzin Günlerini Belirle" style="margin-left:5px;height:43px; vertical-align:middle;float:left;" class="btn"/>
        <a href="index.php?EDFormu&kapat" class="btn" style="float:left;height:20px;padding-top:12px;font-weight:bold;margin-left:5px;text-decoration:none;">Kapat</a>
        </form>
