...
<table border="0" width="100%" class="EDTable" style="border:0;" cellspacing="0">
	<tr><td colspan="7" style="border:0;"><h4 style="margin:0;">DERS VE DÝÐER FAALÝYETLER</h4></td></tr>
	<tr>
    	<td style="border-right:0;width:30px;text-align:center;"><H4 style="margin:0;">NO</H4></td>
    	<td style="border-right:0;width:70px;text-align:center;"><H4 style="margin:0;">KODU</H4></td>
    	<td style="border-right:0;"><H4 style="margin:0;">ADI</H4></td>
    	<td style="border-right:0;width:55px;"><H4 style="margin:0;">ÞEKÝL</H4></td>
    	<td style="border-right:0;"><H4 style="margin:0;">VERÝLDÝÐÝ BÝRÝM</H4></td>
    	<td style="border-right:0;width:30px;" align="center"><H4 style="margin:0;">TS</H4></td>
    	<td style="width:30px;" align="center"><H4 style="margin:0;">US</H4></td>
    </tr>
    <?php 
		@include('../../inc/baglan.php'); 
		$say=0;
    ...
    <?php } ?>
    <tr>
    	<td style="border-right:0;border-top:0;" align="right" colspan="5"><h4 style="margin:0;">ARA TOPLAM</h4></td>
    ...
    <tr><td colspan="7" style="border-top:0px;"><h4 style="margin:0;">DÝÐER BÝRÝMLERDE GÝRDÝÐÝ DERSLER VE UYGULAMALAR</h4></td></tr>
    <?php 
		@include('../../inc/baglan.php'); 
		$TStoplam2=0;
		$UStoplam2=0;			
    ...
    <tr>
    	<td style="border-right:0;border-top:0;" align="right" colspan="5"><h4 style="margin:0;">GENEL TOPLAM</h4></td>
