...
<form method="post" action="index.php?kullanici" target="_self">
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="7">
            ...
            <tr>
                ...
                <td><input type="text" name="kullanici" value="<?php echo $_SESSION["$_SERVER[SERVER_NAME]derslikYonetimkadi"]; ?>" style="width:300px;text-align:center; font-weight:bold;"> <span style="color:#060;">*</span></td>
            </tr>
            <tr>
